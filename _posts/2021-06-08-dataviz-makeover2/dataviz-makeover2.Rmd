...
![Figure 10: Split column selection](Image/SplitColumn.JPG){width=60%}
...
![Figure 12: Output file selections](Image/OutputSelections.JPG){width=30%}
...
![Figure 13: Data Source tab](Image/AutoConnect.JPG){width=50%}
...
![Figure 14: x-axis calculated field formula](Image/Createx-axis.JPG){width=75%}

![Figure 15: y-axis calculated field formula](Image/Createy-axis.JPG){width=75%}
...
![Figure 20: Net Exports/Imports calculated field](Image/NetExportsImportsCalc.JPG){width=75%}
...
![Figure 23: Update colors](Image/UpdateNetExportColors.JPG){width=60%}
...
![Figure 26: Hide header](Image/HideColFieldHeader.JPG)

![Figure 27: Hide header](Image/HideDualAxisHeader.JPG)
...
![Figure 32: Make the above animation selections ](Image/AnimationSelection.JPG){width=50%}
...
![Figure 40: Create Net Export position calculated field](Image/NetExportPosition.JPG){width=75%}

![Figure 41: Create Net Import position calculated field](Image/NetImportPosition.JPG){width=75%}
...
![Figure 45: Create Ranking Calculated field](Image/RankingCalc.JPG){width=75%} 
...
![Figure 49: Update view to Fit Height](Image/FitHeight.JPG){width=75%}
...
![Figure 50: Update range of x-axis ](Image/xGeneralPaneBar.JPG){width=75%}

![Figure 51: Update tick interval of x-axis ](Image/xTickMarksPaneBar.JPG){width=75%}

31. Update the Legend Title by clicking on the small drop down arrow on the legend pane and selecting Edit Title.

![Figure 52: Update legend title](Image/TradeTypeBar.JPG){width=75%}

![Figure 53: Update legend title](Image/UpdateLegendBar-animation.JPG){width=75%}
...
![Figure 54: Edit Tooltip](Image/ToolTipBar.JPG){width=75%}
...
![Figure 44: Create calculated field](Image/TotalMerchTrade.JPG){width=75%} 
...
![Figure 48: Add 45 degree Trend Line](Image/AddTrendLines.JPG){width=75%}
...
![Figure 53: Format Trend Lines](Image/FormatTrendLines.JPG){width=30%}
...
![Figure 56: Hide Export Aligned Header](Image/HideHeader.JPG){width=80%}

48. Update the Legend Title by clicking on the small drop down arrow on the legend pane and selecting Edit Title.

![Figure 57: Update legend title](Image/UpdateLegendDate.JPG){width=75%}

![Figure 58: Update legend title](Image/UpdateLegendMerchTrade.JPG){width=75%}
...
![Figure 59: Edit Size](Image/EditSize.JPG){width=75%}
...
![Figure 60: Make the above animation selections ](Image/AnimationSelectionBubble.JPG){width=50%}
...
![Figure 61: Create 10 new calculated fields with the above formula, updating for the relevant country](Image/CountryCalcField.JPG){width=75%}
...
![Figure 66: Format variables to 2 decimal places](Image/FormatDPBubble.JPG){width=75%}
...
![Figure 67: Change Dashboard Size](Image/DashboardSize.JPG){width=50%}
...
This dashboard consists of three charts:
    i. Bubbleplot showing each region's export and import
...
2. Both exports and imports from Malaysia saw a steep decline in Apr'2020 and rebounded strongly in June'2020. This may be due to the circuit breaker and MCO period in Singapore and Malaysia respectively where citizens were encouraged to stay home and many shops were closed for business. The circuit breaker period in Singapore lasted from Apr'20 to May'20 and measures were relaxed in Jun'20. 

Singapore has consistently been in a net trade deficit with Malaysia since early 2020. Singapore imports over 90% of the food consumed in the country [link](https://www.sfa.gov.sg/food-farming/singapore-food-supply/the-food-we-eat#:~:text=With%20little%20farming%20land%2C%20Singapore,13%25%20of%20all%20the%20vegetables) and hence the lack of transportation options, coupled with the severity of the pandemic in some of the trading partners, may have resulted in increased imports from Malaysia due its geographical proximity.
...
5. Singapore's net trade balance with Hong Kong consistently ranks top out of the ten regions included in this analysis. Europe and United States were typically at the bottom of the ranking but United States has consistently been replaced by Taiwan since Jan'2019.

6. Singapore's net trade balance with Indonesia is on a declining trend across the 10 years, mainly brought about by declining exports. Singapore's main exports to Indonesia are refined petroleum, petrochemicals and telecommunications equipment [link](https://www.enterprisesg.gov.sg/-/media/esg/files/media-centre/media-releases/2020/feb-2020/mr-002a20-singapore-and-indonesia/annex-b---latest-bilateral-trade-information-between-indonesia-and-singapore.pdf?la=en).
...
8. Sharp increase in exports to Thailand in Mar'20, followed by a steep decline till May'20. We see a similar spike in imports from Thailand in Apr'20, followed by a sharp decline to Jun'20. Main exports and imports from Thailand is refined petroleum.Weak refining margins prompted Thai refiners to reduce their operating rates and carry out some minor maintenance, causing lower crude import volumes in May'20.

9. Spike in exports to Mainland China between Jul'20 to Aug'20 and maintaining at a higher range since then. This may be due to China being one of the first countries to recover economically from the pandemic. China’s economy picked up speed in the fourth quarter, with growth beating expectations. [link](https://www.straitstimes.com/business/economy/china-becomes-only-major-economy-to-avoid-recession-in-2020-growth-accelerates-in). This may explain the increase in exports to China during the last quarter of 2020.