...
![Figure 3: Extract relevant data](Image/countrydata.JPG)
...
![Figure 4: Transposed data](Image/transposeddata.JPG)

3. Combine the transposed import and export data.

![Figure 5: Combined data](Image/combineddata.JPG)
...
![Figure 6: Rename columns](Image/renamecolumns.JPG)

After the above manipulations have been performed, save the data as "data_clean".


### <Singapore's Trade with top 6 countries> sheet

5. Import the data into Tableau.

![Figure 7: Import data into tableau](Image/importtableau.JPG)

6.Change data type- change Date data type to “Date”.

![Figure 8: Create calculated field](Image/changedatefield.JPG)

7. As we will be presenting the charts for 6 countries in the form of a trellis, we have to create 2 calculated fields called "x-axis" and "y-axis".
    (a) Create a new calculated field and name it "x-axis", with the below formula (figure 8).
    (b) Create another calculated field named "y-axis", with the below formula (figure 9).

![Figure 9: Create calculated field](Image/createcalculatedfield.JPG)
![Figure 10: x-axis formula](Image/x-axis-formula.JPG)
![Figure 11: y-axis formula](Image/y-axis-formula.JPG)

7. Drag [Date] to columns and change selection to month. Change data type to continuous.

![Figure 12: Drag date to columns](Image/datecolumn.JPG)
...
![Figure 20: Change colors](Image/editcolor.JPG)
![Figure 21: Adjust opacity](Image/editopacity.JPG)

15. Now that we have created the trellis, we will move on to add labels to each panel. Drag [Country] into the Measure Values Marks card and drop it into Label.This will label the [Exports] and [Imports] line graph within each panel in the trellis with the countries they are representing.

![Figure 22: Label panels](Image/addcountryintolabel.JPG)

17. Hide the net export/ imports axis on the right by deselecting Show Header.

![Figure 24: Hide](Image/hidetrellisx-axis.JPG)
![Figure 25: Hide](Image/hidetrellisy-axis.JPG)
![Figure 26: Hide field label for columns](Image/hidecolfieldlabel.JPG)

18. As we only need 1 country label, instead of 2 as seen in Figure 22 above, we will proceed to right click on the import line graph label and select Mark Label > Never Show. Now we are left with 1 label for each panel <font size 9>.

![Figure 27: Hide label for import line graph](Image/hidelabel.JPG)

19. Select and move the remaining label to the top left of each panel.

![Figure 28: Align remaining label to top left of each panel](Image/movelabels.JPG)
...
![Figure 29: Update range and title of y-axis](Image/generalpane.JPG) ![Figure 30: Update tick interval of y-axis](Image/tickmarkspane.JPG)  
...
![Figure 31: Update range and title of x-axis](Image/xgeneralpane.JPG) 
![Figure 32: Update tick interval of x-axis](Image/xtickmarkspane.JPG) 
# Final Visualisation
...
![Figure 33: Update legend title](Image/updatelegendtradetype.JPG) 
![Figure 34: Update legend title](Image/updatelegendnetexport.JPG)

23. Add title: Singapore's Merchandise Trade with Top Six Trading Countries, 2019-2020 <font size 15>.

24. Edit Tooltip in the Measure Values (Figure 35) and Sum(Net Exports/Imports) Marks cards.

![Figure 35: Edit Tooltip for Measure Values Marks card](Image/tooltipmeasurevalues.JPG)

![Figure 36: Edit Tooltip for Sum(Net Exports/Imports) Marks card](Image/tooltipnetexports.JPG)
...
4. Add author
  Using Objects > Text > drag to bottom left of dashboard and add:
